...
export function CartItems() {
  const {cartDetails, removeItem, setItemQuantity, incrementItem, decrementItem} = useShoppingCart();
  ...
  function removeCartItem(product: Product) {
    ...
    toast({
      ...
      description: "Product was removed from your cart.",
      variant: "destructive"
    });
  }
          ...
          <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
            <div className="relative justify-between pr-9 sm:flex sm:gap-x-6 sm:pr-0">
              <div>
                ...
                <p className="mt-1 text-sm font-medium">{formatCurrencyString({currency: product.currency, value: product.price})}</p>
