      ...
      action: (
        <Link href="/cart">
          <Button  variant="link" className="gap-x-2 whitespace-nowrap">
            <span>Open Cart <ArrowRight className="ml-2 h-5 w-5" /></span>
          </Button>
        </Link>
      )
    })
  ...
  return (
    <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
      ...
      <div className="mt-3">
        ...
        <p className="text-3xl tracking-tight">{formatCurrencyString({ currency: product.currency, value: product.price })}</p>
      </div>
